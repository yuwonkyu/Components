  ...
  return (
    <>
      ...
      <main className="flex-1 p-8 bg-gradient-to-br from-primary-50 to-purple-100">
        <ComponentShowcase title="Modal & Overlay Components">
          {/* 기본 모달 섹션 */}
                ...
                >
                  <div>
                    <p className="text-secondary-700 mb-4">
                      This is a basic modal example. You can put any content
                      here.
                    </p>
                ...
                >
                  <div>
                    ...
                    <p className="text-secondary-600 mb-4">
                      This is a side drawer that slides in from the right side
                      of the screen.
                    </p>
