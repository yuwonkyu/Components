  ...
  return (
    <>
      ...
      <main className="flex-1 p-8 bg-gradient-to-br from-primary-50 to-purple-100">
        <ComponentShowcase title="Animation Components">
          {/* 로딩 애니메이션 섹션 */}
          <section className="component-section">
            <h3 className="component-section-title">Loading Animations</h3>
              ...
              <div className="component-card">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-secondary-600">Spinner</p>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-secondary-600">Bouncing Dots</p>
                  </div>
